...
# Event Type: 13244???
#
# ASCII decay Descriptor: [B0 ->  ( [chi_c1(1P) , chi_c2(1P)] -> (J/psi(1S) -> mu+ mu-) gamma ) pi+ pi- ]cc
#
...
ToolSvc().EvtGenDecay.UserDecayFile = "$DECFILESROOT/dkfiles/Bd_chicpipi,Jpsig,mm=TightCuts.dec"
...
tightCut.Decay     = '[ B0  ->  ( Meson -> ^( J/psi(1S) => ^mu+ ^mu-) ^gamma ) pi+ pi-) ]CC'
tightCut.Cuts      =    {
    'gamma'     : ' goodGamma ' ,
    '[mu+]cc'   : ' goodMuon  ' , 
    '[pi+]cc'   : ' goodPion  ' , 
