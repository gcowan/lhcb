...
// Wed May 29 16:36:01 2013 by ROOT version 5.34/05
// from TTree jpsiphi/jpsiphi
// found on file: ../../data/Data_BuJpsiK_WrongPV_Strip17b_Bu2JpsiKdetachedLine.root
//////////////////////////////////////////////////////////

#ifndef wrongPV_shape_2_h
#define wrongPV_shape_2_h
...
public :
   ...
   wrongPV_shape_2(TTree *tree=0);
   virtual ~wrongPV_shape_2();
...
#ifdef wrongPV_shape_2_cxx
wrongPV_shape_2::wrongPV_shape_2(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("../../data/Data_BuJpsiK_WrongPV_Strip17b_Bu2JpsiKdetachedLine.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("../../data/Data_BuJpsiK_WrongPV_Strip17b_Bu2JpsiKdetachedLine.root");
      }
...
wrongPV_shape_2::~wrongPV_shape_2()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t wrongPV_shape_2::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t wrongPV_shape_2::LoadTree(Long64_t entry)
{
...
void wrongPV_shape_2::Init(TTree *tree)
{
...
void wrongPV_shape_2::Show(Long64_t entry)
{
...
Int_t wrongPV_shape_2::Cut(Long64_t entry)
{
...
#endif // #ifdef wrongPV_shape_2_cxx
