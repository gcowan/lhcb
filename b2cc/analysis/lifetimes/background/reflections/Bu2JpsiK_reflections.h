...
// Tue May 21 17:05:45 2013 by ROOT version 5.34/05
// from TTree jpsiphi/jpsiphi
// found on file: ../../data/Data_BuJpsiK_Strip17b_Bu2JpsiKdetachedLine.root
//////////////////////////////////////////////////////////

#ifndef Bu2JpsiK_reflections_h
#define Bu2JpsiK_reflections_h
...
public :
   ...
   Bu2JpsiK_reflections(TTree *tree=0);
   virtual ~Bu2JpsiK_reflections();
...
#ifdef Bu2JpsiK_reflections_cxx
Bu2JpsiK_reflections::Bu2JpsiK_reflections(TTree *tree) : fChain(0) 
{
...
Bu2JpsiK_reflections::~Bu2JpsiK_reflections()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t Bu2JpsiK_reflections::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t Bu2JpsiK_reflections::LoadTree(Long64_t entry)
{
...
void Bu2JpsiK_reflections::Init(TTree *tree)
{
...
Bool_t Bu2JpsiK_reflections::Notify()
{
...
void Bu2JpsiK_reflections::Show(Long64_t entry)
{
...
Int_t Bu2JpsiK_reflections::Cut(Long64_t entry)
{
...
#endif // #ifdef Bu2JpsiK_reflections_cxx
