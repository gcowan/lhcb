...
class HistosAndTuples(Algo):
    ...
    def analyse( self ) :   ## IMPORTANT!
        ...
        for p in particles:
            ...
            self.treatKine   ( tup , proton  , '_pplus' )
            self.treatKine   ( tup , kaon , '_kminus' )
            self.treatProtons( tup , p ) ## fill some basic information for all pions
            self.treatKaons  ( tup , p ) ## fill some basic information for all pions
            ...
            dtf_proton_PX_chic1P_constr  = DTF_FUN ( CHILD(PX, 2) , True  , strings(['J/psi(1S)', 'chi_c1(1P)']) )
            dtf_proton_PY_chic1P_constr  = DTF_FUN ( CHILD(PY, 2) , True  , strings(['J/psi(1S)', 'chi_c1(1P)']) )
            dtf_proton_PZ_chic1P_constr  = DTF_FUN ( CHILD(PZ, 2) , True  , strings(['J/psi(1S)', 'chi_c1(1P)']) )
            dtf_proton_PE_chic1P_constr  = DTF_FUN ( CHILD( E, 2) , True  , strings(['J/psi(1S)', 'chi_c1(1P)']) )
            dtf_kaon_PX_chic1P_constr = DTF_FUN ( CHILD(PX, 3) , True  , strings(['J/psi(1S)', 'chi_c1(1P)']) )
            dtf_kaon_PY_chic1P_constr = DTF_FUN ( CHILD(PY, 3) , True  , strings(['J/psi(1S)', 'chi_c1(1P)']) )
            dtf_kaon_PZ_chic1P_constr = DTF_FUN ( CHILD(PZ, 3) , True  , strings(['J/psi(1S)', 'chi_c1(1P)']) )
            dtf_kaon_PE_chic1P_constr = DTF_FUN ( CHILD( E, 3) , True  , strings(['J/psi(1S)', 'chi_c1(1P)']) )
            ...
            dtf_proton_PX_chic2P_constr  = DTF_FUN ( CHILD(PX, 2) , True  , strings(['J/psi(1S)', 'chi_c2(1P)']) )
            dtf_proton_PY_chic2P_constr  = DTF_FUN ( CHILD(PY, 2) , True  , strings(['J/psi(1S)', 'chi_c2(1P)']) )
            dtf_proton_PZ_chic2P_constr  = DTF_FUN ( CHILD(PZ, 2) , True  , strings(['J/psi(1S)', 'chi_c2(1P)']) )
            dtf_proton_PE_chic2P_constr  = DTF_FUN ( CHILD( E, 2) , True  , strings(['J/psi(1S)', 'chi_c2(1P)']) )
            dtf_kaon_PX_chic2P_constr = DTF_FUN ( CHILD(PX, 3) , True  , strings(['J/psi(1S)', 'chi_c2(1P)']) )
            dtf_kaon_PY_chic2P_constr = DTF_FUN ( CHILD(PY, 3) , True  , strings(['J/psi(1S)', 'chi_c2(1P)']) )
            dtf_kaon_PZ_chic2P_constr = DTF_FUN ( CHILD(PZ, 3) , True  , strings(['J/psi(1S)', 'chi_c2(1P)']) )
            dtf_kaon_PE_chic2P_constr = DTF_FUN ( CHILD( E, 3) , True  , strings(['J/psi(1S)', 'chi_c2(1P)']) )
            ...
            tup.column_float("bkgcat_proton",  self.bkg.category(proton))
            tup.column_float("bkgcat_kaon", self.bkg.category(kaon))
            ...
            tup.column_float( 'proton_PX_chic1_constr' , dtf_proton_PX_chic1P_constr ( p ) / GeV )
            tup.column_float( 'proton_PY_chic1_constr' , dtf_proton_PY_chic1P_constr ( p ) / GeV )
            tup.column_float( 'proton_PZ_chic1_constr' , dtf_proton_PZ_chic1P_constr ( p ) / GeV )
            tup.column_float( 'proton_PE_chic1_constr' , dtf_proton_PE_chic1P_constr ( p ) / GeV )
            tup.column_float( 'kaon_PX_chic1_constr' , dtf_kaon_PX_chic1P_constr ( p ) / GeV )
            tup.column_float( 'kaon_PY_chic1_constr' , dtf_kaon_PY_chic1P_constr ( p ) / GeV )
            tup.column_float( 'kaon_PZ_chic1_constr' , dtf_kaon_PZ_chic1P_constr ( p ) / GeV )
            tup.column_float( 'kaon_PE_chic1_constr' , dtf_kaon_PE_chic1P_constr ( p ) / GeV )
            ...
            tup.column_float( 'proton_PX_chic2_constr' , dtf_proton_PX_chic2P_constr ( p ) / GeV )
            tup.column_float( 'proton_PY_chic2_constr' , dtf_proton_PY_chic2P_constr ( p ) / GeV )
            tup.column_float( 'proton_PZ_chic2_constr' , dtf_proton_PZ_chic2P_constr ( p ) / GeV )
            tup.column_float( 'proton_PE_chic2_constr' , dtf_proton_PE_chic2P_constr ( p ) / GeV )
            tup.column_float( 'kaon_PX_chic2_constr' , dtf_kaon_PX_chic2P_constr ( p ) / GeV )
            tup.column_float( 'kaon_PY_chic2_constr' , dtf_kaon_PY_chic2P_constr ( p ) / GeV )
            tup.column_float( 'kaon_PZ_chic2_constr' , dtf_kaon_PZ_chic2P_constr ( p ) / GeV )
            tup.column_float( 'kaon_PE_chic2_constr' , dtf_kaon_PE_chic2P_constr ( p ) / GeV )
...
if __name__ == '__main__' :
    ...
    inputdata = [
	'/lhcb/MC/2012/ALLSTREAMS.DST/00039817/0000/00039817_00000029_2.AllStreams.dst'
	]
