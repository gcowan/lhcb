...
void plot_resolution_sim_2g(){
	...
	RooRealVar *sf2 = new RooRealVar("sf2", "sf2", 4.0, 0.1, 5.);
	RooRealVar *frac_g12 = new RooRealVar("frac_g12", "core fraction", 0.15, 0.05, 0.4);

	RooRealVar *sigma_wide = new RooRealVar("#sigma wide","width of gwide",0.15,0.05,1.5);
	RooRealVar *tau = new RooRealVar("tau", "tau",0.15, 0.1, 0.3);
	RooRealVar *tau2 = new RooRealVar("tau2", "tau2",1.3, 0.5, 5.0);
	RooRealVar *DG = new RooRealVar("DG", "DG",0.0);

	RooGaussModel *gauss11 = new RooGaussModel("gauss11","gauss",*time, *mean_g1,*sf1, *sigmat);
	RooGaussModel *gauss12 = new RooGaussModel("gauss12","gauss",*time, *mean_g1,*sf2, *sigmat);
	...
	xachse = timepull1->GetXaxis(); yachse = timepull1->GetYaxis();
	...
	timepull2->addPlotable(hpull1,"P") ;
	xachse2 = timepull2->GetXaxis(); yachse2 = timepull2->GetYaxis();
	...
	c->SaveAs("plot_data_sim_2g_wide.pdf");
}
