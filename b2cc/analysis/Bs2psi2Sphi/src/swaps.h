...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/afs/cern.ch/user/g/gcowan/lhcb/lhcb/b2cc/analysis/Bs2psi2Sphi/data/2011_2012_sweighted.roo");
      if (!f || !f->IsOpen()) {
         f = new TFile("/afs/cern.ch/user/g/gcowan/lhcb/lhcb/b2cc/analysis/Bs2psi2Sphi/data/2011_2012_sweighted.root");
      }
