...
void getHltAcceptance(TString const& filename, particleProperties* prop, Int_t const& bins = 20)
{
  ...
  RooRealVar Weight2("Weight2","Weight2",0.,100.,"") ;
  ...
  RooDataSet* data = new RooDataSet("data", "data", data_, *data_->get(), 0, "Weight2");
  ...
  for(Int_t i(0); i< bins; i++){
    ...
    ratio_Hlt1DiMuon_Hlt2DiMuonDetached_S = n_A_1_S/(n_A_1_S+n_A_2_S);
    ratio_Hlt1DiMuon_notHlt2DiMuonDetached_S = n_A_2_S/(n_A_1_S+n_A_2_S);
    ratio_Hlt1TrackAndTrackMuonExcl_Hlt2DiMuonDetached_S = n_B_1_S/n_B_2_S;
