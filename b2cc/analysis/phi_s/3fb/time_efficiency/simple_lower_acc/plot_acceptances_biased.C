{
	...
	if (false){
		//f = TFile::Open("excl_biased_all_time_efficiency_50bin_fixed.root", "READ");
		e = TFile::Open("excl_biased_trigger_time_efficiency_50bins_fixed.root", "READ");
		//g = TFile::Open("excl_biased_all_time_efficiency_50_bins_fixed_DG0.root", "READ");
		...
		f = TFile::Open("excl_biased_all_time_efficiency_50bins_variable.root", "READ");
		e = TFile::Open("excl_biased_trigger_time_efficiency_50bins_variable.root", "READ");
		g = TFile::Open("excl_biased_all_time_efficiency_50_bins_variable_DG0.root", "READ");
		h = TFile::Open("/Disk/speyside8/lhcb/gcowan1/MC2012_sim08e_Bs2JpsiPhi_minimal_truth_with_IPz_weights_v2.root");
