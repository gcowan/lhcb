...
// Wed May 28 18:46:52 2014 by ROOT version 5.34/18
// from TChain BsPrescaledTuple/DecayTree/
//////////////////////////////////////////////////////////

#ifndef dump_contents_h
#define dump_contents_h
...
public :
   ...
   Int_t           B_s0_OS_nnetKaon_DEC;
   Double_t        B_s0_OS_nnetKaon_PROB;
   Int_t           B_s0_SS_nnetKaon_DEC;
   Double_t        B_s0_SS_nnetKaon_PROB;
   Double_t        B_s0_X;
   Double_t        B_s0_Y;
   ...
   TBranch        *b_B_s0_OS_nnetKaon_DEC;   //!
   TBranch        *b_B_s0_OS_nnetKaon_PROB;   //!
   TBranch        *b_B_s0_SS_nnetKaon_DEC;   //!
   TBranch        *b_B_s0_SS_nnetKaon_PROB;   //!
   TBranch        *b_B_s0_X;   //!
   TBranch        *b_B_s0_Y;   //!
   ...
   dump_contents(TTree *tree=0);
   virtual ~dump_contents();
...
#ifdef dump_contents_cxx
dump_contents::dump_contents(TTree *tree) : fChain(0) 
{
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      ...
      f->GetObject("BsPrescaledTuple/DecayTree",tree);
...
Int_t dump_contents::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t dump_contents::LoadTree(Long64_t entry)
{
...
void dump_contents::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("B_s0_OS_nnetKaon_DEC", &B_s0_OS_nnetKaon_DEC, &b_B_s0_OS_nnetKaon_DEC);
   fChain->SetBranchAddress("B_s0_OS_nnetKaon_PROB", &B_s0_OS_nnetKaon_PROB, &b_B_s0_OS_nnetKaon_PROB);
   fChain->SetBranchAddress("B_s0_SS_nnetKaon_DEC", &B_s0_SS_nnetKaon_DEC, &b_B_s0_SS_nnetKaon_DEC);
   fChain->SetBranchAddress("B_s0_SS_nnetKaon_PROB", &B_s0_SS_nnetKaon_PROB, &b_B_s0_SS_nnetKaon_PROB);
...
void dump_contents::Show(Long64_t entry)
{
...
Int_t dump_contents::Cut(Long64_t entry)
{
