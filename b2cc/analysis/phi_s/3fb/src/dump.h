...
// Wed May 28 17:45:27 2014 by ROOT version 5.34/18
// from TTree DecayTree/DecayTree
// found on file: /tmp/MC2011MagUpPythia8_BsJpsiPhi_DTT_20131006.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/tmp/MC2011MagUpPythia8_BsJpsiPhi_DTT_20131006.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/tmp/MC2011MagUpPythia8_BsJpsiPhi_DTT_20131006.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("/tmp/MC2011MagUpPythia8_BsJpsiPhi_DTT_20131006.root:/BsPrescaledTuple");
