...
// Wed May 14 18:11:45 2014 by ROOT version 5.34/18
// from TTree DecayTree/DecayTree
// found on file: /Disk/speyside8/lhcb/gcowan1/Bs2JpsiPhi_MC2012_ntupleA_20130904.root
//////////////////////////////////////////////////////////
...
#ifdef plot_IPz_cxx
plot_IPz::plot_IPz(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/Disk/speyside8/lhcb/gcowan1/Bs2JpsiPhi_MC2012_ntupleA_20130904.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/Disk/speyside8/lhcb/gcowan1/Bs2JpsiPhi_MC2012_ntupleA_20130904.root");
      }
...
Int_t plot_IPz::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t plot_IPz::LoadTree(Long64_t entry)
{
...
void plot_IPz::Show(Long64_t entry)
{
...
Int_t plot_IPz::Cut(Long64_t entry)
{
