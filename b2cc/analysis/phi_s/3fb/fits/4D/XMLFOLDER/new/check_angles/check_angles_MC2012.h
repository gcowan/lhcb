...
// Mon May 26 15:24:04 2014 by ROOT version 5.34/10
// from TTree DecayTree/DecayTree
// found on file: /Disk/speyside8/lhcb/gcowan1/Bs2JpsiPhi_MC2012_ntupleB_20130904_with_IPz_weights.root
//////////////////////////////////////////////////////////

#ifndef check_angles_MC2012_h
#define check_angles_MC2012_h
...
public :
   ...
   TBranch        *b_sel;   //!
   TBranch        *b_B_velo_eff_weight;   //!

   check_angles_MC2012(TTree *tree=0);
   virtual ~check_angles_MC2012();
...
#ifdef check_angles_MC2012_cxx
check_angles_MC2012::check_angles_MC2012(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/Disk/speyside8/lhcb/gcowan1/Bs2JpsiPhi_MC2012_ntupleB_20130904_with_IPz_weights.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/Disk/speyside8/lhcb/gcowan1/Bs2JpsiPhi_MC2012_ntupleB_20130904_with_IPz_weights.root");
      }
...
check_angles_MC2012::~check_angles_MC2012()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t check_angles_MC2012::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t check_angles_MC2012::LoadTree(Long64_t entry)
{
...
void check_angles_MC2012::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("time_diff", &time_diff, &b_time_diff);
   fChain->SetBranchAddress("trueid", &trueid, &b_trueid);
   ...
   fChain->SetBranchAddress("pythia", &pythia, &b_pythia);
   ...
   fChain->SetBranchAddress("B_velo_eff_weight", &B_velo_eff_weight, &b_B_velo_eff_weight);
   Notify();
}

Bool_t check_angles_MC2012::Notify()
{
...
void check_angles_MC2012::Show(Long64_t entry)
{
...
Int_t check_angles_MC2012::Cut(Long64_t entry)
{
...
#endif // #ifdef check_angles_MC2012_cxx
