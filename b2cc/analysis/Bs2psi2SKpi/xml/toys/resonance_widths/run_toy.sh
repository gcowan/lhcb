#!/bin/bash
#$ -e /Disk/speyside8/lhcb/gcowan1/Z4430/B_s0/xml/toys/resonance_widths/logs/
#$ -o /Disk/speyside8/lhcb/gcowan1/Z4430/B_s0/xml/toys/resonance_widths/logs/
#$ -l h_rt=00:30:00
...
$RAPIDFITROOT/bin/fitting -f $CONFIG3 --saveFitXML          --calculateFitFractions --OutputLevel 1 | tee fitFractions_with_bkg_modified_stdout 
mv fitFractions.root fitFractions_with_bkg_modified.root
$SRC/modify_toy.sh
# Then re-compute the fit fractions, but without acceptance and background
$RAPIDFITROOT/bin/fitting -f outputXMLFile.xml              --calculateFitFractions --OutputLevel 1 | tee fitFractions_without_bkg_modified_stdout 
