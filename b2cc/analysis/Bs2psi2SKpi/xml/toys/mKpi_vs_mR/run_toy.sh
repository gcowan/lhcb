...
RAPIDFITMODROOT=/Home/gcowan1/software/RapidFit_CPLAB_mod/trunk
RAPIDFITROOTTMP=/Home/gcowan1/software/tmp/trunk
BC=/Disk/speyside8/lhcb/gcowan1/Z4430/B_s0/xml/toys/mKpi_vs_mR
...
$RAPIDFITMODROOT/bin/fitting -f $CONFIG1 --saveOneDataSet toy.root --useUUID | tee gen_stdout
