...
CONFIG1=$BC/nominal_gen_very_high_N.xml
CONFIG2=$BC/nominal_fit_very_high_N.xml
...
datadir=$BC/results_new_Fit1_very_high_N/
mkdir -p $datadir
...
$SRC/modify_for_gen_very_high_N.sh outputXMLFile2.xml
