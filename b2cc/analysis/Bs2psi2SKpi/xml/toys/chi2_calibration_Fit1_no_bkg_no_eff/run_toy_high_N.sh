...
BC=/Disk/speyside8/lhcb/gcowan1/Z4430/B_s0/xml/toys/chi2_calibration_Fit1_no_bkg_no_eff
SRC=/Disk/speyside8/lhcb/gcowan1/Z4430/B_s0/src
CONFIG1=$BC/nominal_gen_high_N.xml
CONFIG2=$BC/nominal_fit_high_N.xml
...
datadir=$BC/results_new_Fit1_high_N/
mkdir -p $datadir
...
$SRC/modify_for_gen_high_N.sh outputXMLFile2.xml
...
root -l -q $SRC/compute_chi2_toy_more_bins.C | tee chi2_large_stdout
...
cp -f  chi2_large.root   $datadir/${myID}_chi2_large.root
cp -f  chi2_large_stdout $datadir/${myID}_chi2_large_stdout
#rm -rf $workdir
