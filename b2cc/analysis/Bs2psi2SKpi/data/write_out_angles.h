...
// used to generate this class and read the Tree.
   if (tree == 0) {
      ...
      //TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("default-data.root");
      //TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("tighter_cut/tight-mva.root");
      //TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("tighter_cut/ssbackground_Selected_Clean_Tight.root");
      //TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("tighter_cut/BsKpi-mc_Tight_proton.root");
      //TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("tighter_cut/newbdmc_Tight_proton.root");
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("tighter_cut/BdKpi-mc_Tight_proton.root");
      //TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("no_mva/BsKpi-mc_proton_nomva.root");
      //TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("no_mva/dsKpi-mc_proton_nomva.root");
      ...
      if (!f || !f->IsOpen()) {
         ...
         //f = new TFile("default-data.root");
         //f = new TFile("tighter_cut/tight-mva.root");
         //f = new TFile("tighter_cut/ssbackground_Selected_Clean_Tight.root");
         //f = new TFile("tighter_cut/BsKpi-mc_Tight_proton.root");
         //f = new TFile("tighter_cut/newbdmc_Tight_proton.root");
         f = new TFile("tighter_cut/BdKpi-mc_Tight_proton.root");
         //f = new TFile("no_mva/BsKpi-mc_proton_nomva.root");
         //f = new TFile("no_mva/BdKpi-mc_proton_nomva.root");
