...
void correlation_toy()
{
  ...
  // Parameters
  RooRealVar dm("dm","delta m(B0)",17.7, 15, 20) ;
  RooRealVar dg("dg","delta Gamma",0.1) ;
  RooRealVar tau("tau","tau (B0)",1.5) ;
  RooRealVar phis("phis","phis", 0.05, -2, 2) ;
  ...
  RooBDecay bmix("bmix","decay",dt,tau,dg, RooRealConstant::value(1), RooRealConstant::value(1), RooRealConstant::value(0), S, dm, tm,RooBMixDecay::SingleSided) ;
