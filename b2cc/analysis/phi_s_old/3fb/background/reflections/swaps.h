...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("../../data/Bs2JpsiPhi_2012_20130502_Kminus_pidp_tupleB.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("../../data/Bs2JpsiPhi_2012_20130502_Kminus_pidp_tupleB.root");
      }
